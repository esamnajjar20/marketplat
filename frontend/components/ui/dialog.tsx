...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {/* FIX UX-01: end-4 (logical) instead of right-4 (physical), and
          bg-muted instead of stock bg-accent — see button.tsx for the
          accent-token reasoning. Screen-reader label translated to
          Arabic to match the rest of the app's a11y copy. */}
