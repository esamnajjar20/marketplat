...
// FIX UX-01: focus/hover states below use bg-muted rather than the
// stock shadcn bg-accent — see components/ui/button.tsx for why: this
// app's --accent token now carries the brand terracotta, reserved for
// the "featured" signature, not a neutral hover tint.
