...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    servers: [
      ...
      { url: 'https://api.classifieds-platform.com/api/v1', description: 'Production' },
    ],
    components: {
      securitySchemes: {
      ...
      schemas: {
        ...
        CreateAdRequest: {
          ...
          properties: {
            title: { type: 'string', minLength: 3, maxLength: 200, example: 'iPhone 14 Pro للبيع' },
        ...
        ReportAdRequest: {
          ...
          required: ['reason'],
          properties: {
            reason: { type: 'string', enum: ['SCAM', 'FAKE', 'OFFENSIVE', 'SPAM'] },
